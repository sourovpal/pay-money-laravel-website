                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="text-center"><p><strong> {{ __(':x received successfully.', ['x' => $walletCurrencyCode]) }}</strong></p></div>
                                <div class="text-center"><p><strong> {{ __('Amount will be added after :x confirmations.', ['x' => $confirmations]) }}</strong></p></div>
                                <div class="text-center"><p> {{ __('Address: :x', ['x' => $receiverAddress]) }}</p></div>
                                <h5 class="text-center mt10">{{ __('Received Amount: :x', ['x' => moneyFormat($currencySymbol, formatNumber($amount, $currencyId))]) }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="ml-0">
                            ...
                            <div class="float-right">
                                <a href="{{ route('admin.crypto_receive.create', encrypt($walletCurrencyCode)) }}" class="btn btn-theme"><strong>{{ __('Receive :x Again', ['x' => $walletCurrencyCode]) }}</strong></a>
                            </div>
                        </div>
                    </div>
                </div>

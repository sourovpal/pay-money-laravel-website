...
class SmsTemplateController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->helper->one_time_message('success', __('The :x has been successfully saved.', ['x' => __('sms template')]));
        return redirect()->intended(Config::get('adminPrefix').'/sms-template/' . $id);
    }
}

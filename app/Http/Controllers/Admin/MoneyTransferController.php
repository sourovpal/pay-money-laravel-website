        ...
        if ($request->transaction_type == 'Transferred') {
            if ($request->status == 'Pending') {
                if ($request->transaction_status == 'Pending') {
                    ...
                    if (isset($userInfo)) {
                        ...
                        $t_pending_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $t_pending_msg);
                        ...
                        if (!empty($userInfo->carrierCode) && !empty($userInfo->phone))
                        {
                            ...
                            $transfer_status_sms_info_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $transfer_status_sms_info_msg);
                    ...
                    $t_pending_msg = str_replace('{uuid}', $transfers->uuid, $t_pending_msg);
                    $t_pending_msg = str_replace('{status}', ($transfers->status == 'Blocked') ? "Cancelled" : (($transfers->status == 'Refund') ? "Refunded" : $transfers->status), $t_pending_msg);
                    $t_pending_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $t_pending_msg);
                    $t_pending_msg = str_replace('{added/subtracted}', 'subtracted', $t_pending_msg);
                    $t_pending_msg = str_replace('{from/to}', 'from', $t_pending_msg);
                    $t_pending_msg = str_replace('{soft_name}', settings('name'), $t_pending_msg);
                    ...
                    if (!empty($transfers->sender->carrierCode) && !empty($transfers->sender->phone))
                    {
                        ...
                        $transfer_status_sms_info_msg = str_replace('{status}', ($transfers->status == 'Blocked') ? "Cancelled" : (($transfers->status == 'Refund') ? "Refunded" : $transfers->status),
                            $transfer_status_sms_info_msg);
                        $transfer_status_sms_info_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $transfer_status_sms_info_msg);
                        $transfer_status_sms_info_msg = str_replace('{added/subtracted}', 'subtracted', $transfer_status_sms_info_msg);
            ...
            elseif ($request->status == 'Success')
            {
                ...
                elseif ($request->transaction_status == 'Pending') //current status
                {
                    ...
                    if (isset($userInfo))
                    {
                        ...
                        $t_success_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $t_success_msg);
                ...
                elseif ($request->transaction_status == 'Blocked')
                {
                    ...
                    $t_success_msg_1 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $t_success_msg_1);
                    ...
                    if (isset($userInfo))
                    {
                        ...
                        $t_success_msg_2 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $t_success_msg_2);
            ...
            elseif ($request->status == 'Blocked')
            {
                ...
                elseif ($request->transaction_status == 'Success') // done
                {
                    ...
                    $t_block_msg_1 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $t_block_msg_1);
                    ...
                    if (isset($userInfo))
                    {
                        ...
                        $t_block_msg_2 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $t_block_msg_2);
                ...
                elseif ($request->transaction_status == 'Pending') // done
                {
                    ...
                    $t_block_msg = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $t_block_msg);
            ...
            elseif ($request->status == 'Refund')
            {
                ...
                elseif ($request->transaction_status == 'Success') //done
                {
                    ...
                    $t_refund_msg_1 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount + $request->feesTotal)), $t_refund_msg_1);
                    ...
                    if (isset($userInfo))
                    {
                        ...
                        $t_refund_msg_2 = str_replace('{amount}', moneyFormat(optional($transfers->currency)->symbol, formatNumber($request->amount)), $t_refund_msg_2);

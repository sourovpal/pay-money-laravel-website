            ...
            if ($request->status == 'Pending') {
                if ($request->transaction_status == 'Pending') {
                    ...
                    if (isset($merchant_payment->merchant)) {
                        ...
                        $m_mail_body = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, formatNumber($request->amount)), $m_mail_body);
                        ...
                        if (!empty($merchant_payment->merchant->user->carrierCode) && !empty($merchant_payment->merchant->user->phone)) {
                            ...
                            $merchant_status_sms_info_msg = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, $request->amount), $merchant_status_sms_info_msg);
            ...
            elseif ($request->status == 'Refund')
            {
                ...
                elseif ($request->transaction_status == 'Success') //done
                {
                    ...
                    if (isset($merchant_payment->user_id))
                    {
                        ...
                        $m_mail_body = str_replace('{uuid}', $merchant_payment->uuid, $m_mail_body);
                        $m_mail_body = str_replace('{status}', $merchant_payment->status, $m_mail_body);
                        $m_mail_body = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, formatNumber($request->charge_percentage + $request->charge_fixed + $request->amount)), $m_mail_body);
                        $m_mail_body = str_replace('{added/subtracted}', 'added', $m_mail_body);
                        $m_mail_body = str_replace('{from/to}', 'to', $m_mail_body);
                        $m_mail_body = str_replace('{soft_name}', settings('name'), $m_mail_body);
                        ...
                        if (!empty($paid_by_user->user->carrierCode) && !empty($paid_by_user->user->phone))
                        {
                            ...
                            $merchant_status_sms_info_msg = str_replace('{uuid}', $merchant_payment->uuid, $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{status}', $merchant_payment->status, $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, ($request->charge_percentage + $request->charge_fixed + $request->amount)), $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{added/subtracted}', 'added', $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{from/to}', 'to', $merchant_status_sms_info_msg);
            ...
            elseif ($request->status == 'Refund')
            {
                ...
                elseif ($request->transaction_status == 'Success') //done
                {
                    ...
                    if (isset($merchant_payment->user_id))
                    {
                        ...
                        $m_mail_body = str_replace('{uuid}', $merchant_payment->uuid, $m_mail_body);
                        $m_mail_body = str_replace('{status}', $merchant_payment->status, $m_mail_body);
                        $m_mail_body = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, formatNumber($request->amount + $request->charge_percentage + $request->charge_fixed)), $m_mail_body);
                        $m_mail_body = str_replace('{added/subtracted}', 'added', $m_mail_body);
                        $m_mail_body = str_replace('{from/to}', 'to', $m_mail_body);
                        $m_mail_body = str_replace('{soft_name}', settings('name'), $m_mail_body);
                        ...
                        if (!empty($paid_by_user->user->carrierCode) && !empty($paid_by_user->user->phone))
                        {
                            ...
                            $merchant_status_sms_info_msg = str_replace('{uuid}', $merchant_payment->uuid, $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{status}', $merchant_payment->status, $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{amount}', moneyFormat(optional($merchant_payment->currency)->symbol, ($request->amount + $request->charge_percentage + $request->charge_fixed)), $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{added/subtracted}', 'added', $merchant_status_sms_info_msg);
                            $merchant_status_sms_info_msg = str_replace('{from/to}', 'to', $merchant_status_sms_info_msg);

            ...
            <div class="box box-info">
                ...
                <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/edit-merchant-group/'. $merchantGroup->id) }}" class="form-horizontal" id="merchant-group-edit-form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end">{{ __('Fee') }} (%)</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                @if ($merchantGroup->is_default == 'Yes')
                                        <p class="f-14 mb-0"><span class="label label-success">{{$merchantGroup->is_default}}</span></p>
                    ...
                    <div class="box-footer">
                        <a class="btn btn-theme-danger f-14" href="{{ url(\Config::get('adminPrefix').'/settings/merchant-group') }}">{{ __('Cancel') }}</a>

        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="d-flex justify-content-between">
                    <div>
                        <a href="{{ url(\Config::get('adminPrefix')."/users/deposit/print/".$transInfo['id'])}}" target="_blank" class="btn button-secondary"><strong class="f-14">{{ __('Print') }}</strong></a>
                    </div>
                    <div>
                        <a href="{{ url(\Config::get('adminPrefix')."/users/deposit/create/" . $users->id)}}" class="btn btn-theme"><strong class="f-14">{{ __('Deposit Again') }}</strong></a>
                    </div>
                </div>
            </div>
        </div>

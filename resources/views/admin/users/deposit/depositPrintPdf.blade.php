        ...
        <table>
            <tr>
                <td>
                    <table>
                        <tr>
                            <td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">{{ __('Deposited Via') }}</td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <table style="margin-top:20px; width:300px;">
                        ...
                        <tr>
                            <td style="font-size:15px; color:#000000;">{{ __('Deposited Amount') }}</td>
                        ...
                        <tr>
                            ...
                            <td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
                                {{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->total, $transactionDetails->currency->id)) }}
                            </td>
                        </tr>
                    </table>
                </td>

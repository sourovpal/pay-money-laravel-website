...
<div class="box">
    <div class="box-body">
        ...
        <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/tickets/update') }}" method="POST" id="edit_ticket_form">
            {{csrf_field()}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-2 control-label f-14 fw-bold text-end require">{{ __('Subject') }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 control-label f-14 fw-bold text-end require">{{ __('Body') }}</label>
                        <div class="col-sm-10">
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-4 control-label f-14 fw-bold text-end require">{{ __('Assignee') }}</label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-4 control-label f-14 fw-bold text-end">{{ __('Status') }}</label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-4 control-label f-14 fw-bold text-end require">{{ __('User') }}</label>
                        <div class="col-sm-8">

                            <input id="user_input" type="text" name="user" placeholder="{{ __('Enter Name') }}" class="form-control f-14" value="{{ $ticket->user->first_name.' '.$ticket->user->last_name }}"
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-4 control-label f-14 fw-bold text-end require">{{ __('Priority') }}</label>
                        <div class="col-sm-8">
                ...
                <div class="col-md-6" id="assigned_email_div">
                    <div class="form-group row align-items-center">
                        <label class="col-sm-4 control-label f-14 fw-bold text-end">{{ __('Email') }}</label>
                        <div class="col-sm-8">
                            <input id="assigned_email" type="text" class="form-control f-14" readonly name="email" value="{{ $ticket->user->email }}">
                        </div>
                    </div>
                </div>

                <div class="col-md-6 offset-md-2">
                    <a id="cancel_anchor" class="btn btn-theme-danger f-14 me-1" href="{{ url(\Config::get('adminPrefix').'/tickets/list') }}">{{ __('Cancel') }}</a>
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{ url(\Config::get('adminPrefix').'/ticket_user_search') }}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term

...
@section('page_content')
    <div class="box">
        <div class="box-body pb-20">
            <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/tickets/list') }}" method="GET">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="pr-25">
                                    ...
                                    <input id="user_input" type="text" name="user" placeholder="{{ __('Enter Name') }}" class="form-control f-14"
                                        value="{{ empty($user) ?  $user : (!empty($getName) ? $getName->first_name.' '.$getName->last_name : '') }}"
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'add_ticket'))
                        <a href="{{ url(\Config::get('adminPrefix').'/tickets/add') }}" class="btn btn-theme f-14"><span class="fa fa-plus f-14"> &nbsp;</span>{{ __('Add Ticket') }}</a>
                    @endif
                </div>
            </div>
        </div>

...
<div class="box">
    <div class="box-body">
        ...
        <form id="add_ticket_form" class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/tickets/store') }}" method="POST">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <select name="assignee" class="form-control f-14 select2">
                ...
                <div class="col-md-6">
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <select name="status" class="form-control f-14 select2">

		...
		<div class="box-body ps-3">
			<div class="row align-items-center">
				...
				<div class="col-md-2 offset-md-8 defaultCurrencyDiv dis-none">
                    <h4 class="form-control-static f-14 text-end mb-0"><span class="label label-success f-14">{{ __('Default Currency') }}</span>
                    </h4>
                </div>
			</div>
		</div>
					...
					<div class="box-body">
						...
						@if ($currency->default == 1)
							<div class="form-group row">
								{{-- <label class="col-sm-3 control-label f-14 fw-bold text-end mt-11 default_currency_label" for="has_transaction">Default Currency</label> --}}
						...
						@elseif ($currency->default == 1 && !isset($feeslimit))
							<div class="form-group row">
								<label class="col-sm-3 control-label f-14 fw-bold text-end default_currency_label" for="has_transaction">{{ __('Is Activated') }}</label>
								{{-- <label class="col-sm-3 control-label f-14 fw-bold text-end mt-11 default_currency_label" for="has_transaction">Is Activated</label> --}}
								<div class="col-sm-5">
									<label class="checkbox-container">
						...
						<!-- Maximum Limit -->
						<div class="form-group row">
								<label class="col-sm-3 control-label f-14 fw-bold text-end mt-11" for="max_limit">{{ __('Maximum Limit') }}</label>
								<div class="col-sm-5">
						...
						<!-- Charge Fixed -->
						<div class="form-group row">
							<label class="col-sm-3 control-label f-14 fw-bold text-end mt-11" for="charge_fixed">{{ __('Charge Fixed') }}</label>
							<div class="col-sm-5">
                        ...
                        <div class="mt-3 row">
                            <div class="col-md-6 offset-md-3">
                                <a href="{{  url(\Config::get('adminPrefix')."/settings/currency") }}" class="btn btn-theme-danger f-14 me-1">{{ __('Cancel') }}</a>

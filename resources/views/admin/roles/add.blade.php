  ...
  <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/add_role') }}" class="form-horizontal" id="roles_add_form">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="display_name" class="form-control f-14" value="{{ old('display_name') }}" placeholder="{{ __('Display Name') }}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <textarea name="description" placeholder="{{ __('Description') }}" rows="3" class="form-control f-14" value="{{ old('description') }}"></textarea>

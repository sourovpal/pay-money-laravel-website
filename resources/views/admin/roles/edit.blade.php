  ...
  <div class="row">
      ...
      <div class="col-md-9">
        ...
        <div class="box box-info">
          ...
          <!-- form start -->
          <form method="POST" action="{{ url(\Config::get('adminPrefix').'/settings/edit_role/'. $result->id) }}" class="form-horizontal" id="roles_edit_form">
              {{ csrf_field() }}

              <div class="box-body">

                  <div class="form-group row">
                    <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end">{{ __('Name') }}</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end">{{ __('Display Name') }}</label>
                    <div class="col-sm-6">
                      <input placeholder="{{ __('Display Name') }}" type="text" class="form-control f-14" name="display_name" value="{{ $result->display_name }}" >
                      <span class="text-danger">{{ $errors->first('display_name') }}</span>
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end">{{ __('Description') }}</label>
                    <div class="col-sm-6">
                      <textarea placeholder="{{ __('Description') }}" rows="3" class="form-control f-14" name="description">{{ $result->description }}</textarea>
              ...
              <div class="box-footer">
                <a class="btn btn-theme-danger f-14" href="{{ url(\Config::get('adminPrefix').'/settings/roles') }}">{{ __('Cancel') }}<a>

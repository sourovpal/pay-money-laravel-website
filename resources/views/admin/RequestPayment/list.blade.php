...
@section('page_content')
  <div class="box">
      <div class="box-body pb-20">
          <form class="form-horizontal" action="{{ url(\Config::get('adminPrefix').'/request_payments') }}" method="GET">
                  ...
                  <div class="col-md-12">
                      <div class="d-flex flex-wrap justify-content-between align-items-center">
                          <div class="d-flex flex-wrap">
                            ...
                            <div class="pr-25">
                                <label class="f-14 fw-bold mb-1" for="creator">{{ __('User') }}</label><br>
    ...
    $(document).ready(function()
    {
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url(\Config::get('adminPrefix').'/request_payments/user_search')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term

                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in show active" id="tab_1">
                            <form action="{{ url(\Config::get('adminPrefix').'/settings/app-store-credentials/update-google-credentials') }}" method="POST" class="form-horizontal" id="app-store-google-credentials" enctype="multipart/form-data" >
                                {!! csrf_field() !!}
                                ...
                                <div class="box-body">
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end" for="has_transaction">{{ __('Available') }}</label>
                                        <div class="col-sm-6">
                                    ...
                                    <!-- PlayStore Link -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end" for="playstore[link]">{{ __('Play Store Link') }}</label>
                                        <div class="col-sm-5">
                                    ...
                                    <!-- Play Store Logo -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end mt-2" for="playstore[logo]">{{ __('Play Store Logo') }}</label>
                                        <div class="col-sm-5">
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                      <div class="mt-10">
                                        <a href="{{ url(\Config::get('adminPrefix').'/settings/app-store-credentials') }}" class="btn btn-theme-danger f-14">{{ __('Cancel') }}</a>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <form action="{{ url(\Config::get('adminPrefix').'/settings/app-store-credentials/update-apple-credentials') }}" method="POST" class="form-horizontal" id="app-store-apple-credentials" enctype="multipart/form-data">
                                {!! csrf_field() !!}
                                ...
                                <div class="box-body">
                                    ...
                                    <!-- Apple Store Link -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end" for="applestore[link]">{{ __('Apple Store Link') }}</label>
                                        <div class="col-sm-5">
                                    ...
                                    <!-- Apple Store Logo -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-end mt-2" for="applestore[logo]">{{ __('Apple Store Logo') }}</label>
                                        <div class="col-sm-5">

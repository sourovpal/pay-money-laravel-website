        ...
        <div class="box box-info">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs" id="tabs">
                    <li class="item-nav"><a class="nav-link" href="{{ url(\Config::get('adminPrefix').'/settings/notification-types') }}">{{ __('Notification Types') }}</a></li>
                    <li><a href="{{ url(\Config::get('adminPrefix').'/settings/notification-settings/email')}}">{{ __('Email Notification Settings') }}</a></li>
                </ul>
                    ...
                    <div class="tab-pane fade in show active" id="tab_1">
                        <div>
                            <div class="table-responsive">
                                ...
                                <form action="{{ url(\Config::get('adminPrefix').'/settings/notification-settings/update') }}" method="POST" class="form-horizontal" id="sms_notification_setting_form">
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mt-10">
                                                <a href="{{ url(\Config::get('adminPrefix').'/settings/notification-types') }}" class="btn btn-danger btn-flat">{{ __('Cancel') }}</a>

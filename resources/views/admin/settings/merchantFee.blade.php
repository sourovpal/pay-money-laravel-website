    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="box box-info">
                ...
                <form action="{{ url(\Config::get('adminPrefix').'/settings/merchant-fee') }}" method="post" class="form-horizontal" id="merchant-fee" >
                    {!! csrf_field() !!}
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label" for="inputEmail3">{{ __('Set Merchant Fee') }}</label>
                          <div class="col-sm-6">

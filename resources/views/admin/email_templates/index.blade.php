          ...
          <form action='{{url(\Config::get('adminPrefix').'/template_update/'.$tempId)}}' method="post" id="template">
            ...
            <div class="box-body">
              <div class="form-group">
                  <label class="f-14 fw-bold mb-1" class="f-14 fw-bold mb-1" for="Subject">{{ __('Subject') }}</label>
              ...
              <div class="form-group">
                  <textarea name="en[body]" class="form-control f-14 editor h-300">
                    {{$temp_Data[0]->body}}
                  </textarea>
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="ar[body]" class="form-control f-14 editor h-300">
                            {{$temp_Data[1]->body}}
                          </textarea>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseThree" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="fr[body]" class="form-control f-14 editor h-300">
                            {{$temp_Data[2]->body}}
                          </textarea>
                      </div>
                    </div>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseTwo" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="pt[body]" class="form-control f-14 editor h-300">
                            {{$temp_Data[3]->body}}
                          </textarea>
                      </div>
                    </div>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseFour" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        <textarea name="ru[body]" class="form-control f-14 editor h-300">
                          {{$temp_Data[4]->body}}
                        </textarea>
                      </div>
                    </div>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseFive" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="es[body]" class="form-control f-14 editor h-300">
                            {{$temp_Data[5]->body}}
                          </textarea>
                      </div>
                    </div>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseSix" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="tr[body]" class="form-control f-14 editor h-300">
                          {{$temp_Data[6]->body}}
                          </textarea>
                      </div>
                    </div>
                ...
                <div class="panel box box-success">
                  ...
                  <div id="collapseSeven" class="panel-collapse collapse h-auto" aria-expanded="false">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <textarea name="ch[body]" class="form-control f-14 editor h-180">
                          {{ ($temp_Data[7]->body) }}
                          </textarea>
                      </div>
                    </div>
            ...
            <div class="box-footer">
              <div class="pull-right">
                ...
                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_email_template'))
                  <button type="submit" class="btn btn-theme f-14" id="email_edit">
                      <i class="fa fa-spinner fa-spin f-14 d-none"></i> <span id="email_edit_text">{{ __('Update') }}</span>
                  </button>
                @endif

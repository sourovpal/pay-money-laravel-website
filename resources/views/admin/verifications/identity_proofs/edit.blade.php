...
<section class="min-vh-100">
    <div class="my-30">
        <div class="row">
            <form action="{{ url(\Config::get('adminPrefix').'/identity-proofs/update') }}" class="row form-horizontal" id="deposit_form" method="POST">
                {{ csrf_field() }}
                <!-- Page title start -->
                <div class="col-md-8">
                    <div class="box">
                                ...
                                <div>
                                    <div class="p-4">
                                        ...
                                        @if ($documentVerification->identity_type)
                                            <div class="form-group row">
                                                <label class="control-label f-14 fw-bold text-end col-sm-3" for="identity_type">{{ __('Identity Type') }}</label>
                                        ...
                                        @if ($documentVerification->identity_number)
                                            <div class="form-group row">
                                                <label class="control-label f-14 fw-bold text-end col-sm-3" for="identity_number">{{ __('Identity Number') }}</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 offset-md-3">
                                                <a id="cancel_anchor" class="btn btn-theme-danger f-14 me-1" href="{{ url(\Config::get('adminPrefix').'/identity-proofs') }}">{{ __('Cancel') }}</a>

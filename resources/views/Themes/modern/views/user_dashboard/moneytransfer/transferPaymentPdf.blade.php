						...
						<table style="margin-top:20px; width:300px;">
							...
							@if (abs($transactionDetails->total) - abs($transactionDetails->subtotal) > 0)
								<tr style="padding-bottom:10px;">
									...
									<td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->charge_percentage+$transactionDetails->charge_fixed, $transactionDetails->currency->id)) }}</td>
								</tr>
							@endif
					...
					<td>
						<table style="margin-top:20px; width:300px;">
							...
							<tr>
								<td style="font-size:15px; color:#000000; font-weight:bold;">@lang('message.dashboard.left-table.total')</td>
								<td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">
									{{ moneyFormat(optional($transactionDetails->currency)->symbol, (str_replace("-",'', formatNumber($transactionDetails->subtotal, $transactionDetails->currency->id)))) }}
								</td>
							</tr>
						</table>
					</td>

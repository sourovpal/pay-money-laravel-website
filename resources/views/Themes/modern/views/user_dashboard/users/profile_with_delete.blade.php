                ...
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="float-left">@lang('message.dashboard.setting.title')</h3>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h4 class="addPhoneTitle">{{ __('Add Phone') }}</h4>
                                                <p class="addPhoneBody">{{ __('Click on') }} <b>+</b> {{ __('to add phone') }}</p>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="uploadAvatar">
                                                    <button type="button" class="btn btn-secondary btn-border btn-sm add" data-toggle="modal" data-target="#add" style="margin-top: 10px;">
                                                        ...
                                                        <span class="modalText">&nbsp; {{ __('Add Phone') }}</span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal" id="add">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form method="POST" action="{{ url('profile/complete-phone-verification')}}" id="complete-phone-verification">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">{{ __('Add Phone') }}</h4>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label id="subheader_text">{{ __('Enter the number you’d like to use') }}</label>
                                                                        <br>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <button type="button" class="btn btn-cust" data-dismiss="modal" id="close">{{ __('Cancel') }}</button>
                                                                        </div>

                                                                        <div class="col-md-6">
                                                                            <button type="button" class="btn btn-cust next" id="common_button">{{ __('Next') }}</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <h4 class="editPhoneTitle">{{ __('Phone Number') }}</h4>
                                                ...
                                                <div class="modal" id="editModal">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <form method="POST" action="{{ url('profile/update-phone-number')}}" id="update-phone-number">
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">{{ __('Edit phone') }}</h4>
                                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                </div>
                                                                ...
                                                                <div class="modal-body editModalBody">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label id="subheader_edit_text">{{ __('Enter the number you’d like to use') }}</label>
                                                                        <br>
                                                                        <div class="input-phone">
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            @if ($is_sms_env_enabled == false && $checkPhoneVerification == "Disabled")
                                                                                <button type="button" class="btn btn-cust edit_form_submit" id="common_button_update">{{ __('Update') }}</button>
                                                                            @else
                                                                                <button type="button" class="btn btn-cust update" id="common_button_update">{{ __('Next') }}</button>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <script>
        ...
        //Add
            ...
            $(document).on('click', '.next', function()
            {
                ...
                if (phoneNumber == '')
                {
                    $('#phone-error').addClass('error').html("{{ __('This field is required.') }}").css({
                       'color' : 'red !important',
                       'font-size' : '14px',
                       'font-weight' : '800',
                       'padding-top' : '5px',
                ...
                {
                    $('#phone-error').addClass('error').html("{{ __('Please enter numbers only!') }}").css({
                       'color' : 'red !important',
                       'font-size' : '14px',
                       'font-weight' : '800',
                       'padding-top' : '5px',
                ...
                else
                {
                    ...
                    $('#subheader_text').html("{{ __('To make sure this number is yours, Google will send you a verification code.') }}");
...
///////////////////////////////////////////////////////////////////////////////////
        ...
        //Update
            ...
            $(document).on('click', '.update', function()
            {
                ...
                if (phoneNumber == '')
                {
                    $('#edit-phone-error').addClass('error').html("{{ __('This field is required.') }}").css({
                       'color' : 'red !important',
                       'font-size' : '14px',
                       'font-weight' : '800',
                       'padding-top' : '5px',
                ...
                {
                    $('#edit-phone-error').addClass('error').html("{{ __('Please enter numbers only!') }}").css({
                       'color' : 'red !important',
                       'font-size' : '14px',
                       'font-weight' : '800',
                       'padding-top' : '5px',
                ...
                {
                    $('#subheader_edit_text').html("{{ __('To make sure this number is yours, Google will send you a verification code.') }}");
...
///////////////////////////////////////////////////////////////
        ...
        $(document).on('click', '.delete', function()
        {
            ...
            swal({
              ...
              text: "{{ __('You will not be able to recover this number') }}",
              type: "warning",
            ...
            function(isConfirm)
            {
                ...
                if (isConfirm)
                {
                    ...
                    .done(function(response)
                    {
                        swal({title: "{{ __('Deleted!') }}", text: response.message, type:response.status},
                            function(){
                               window.location.reload();
                            }
                        );
                    ...
                    .fail(function(){
                        swal('Oops...', '{{ __("Something went wrong with ajax !") }}', 'error');
                    });
                }
                else
                {
                    swal("Cancelled", "{{ __('You Cancelled') }}", "error");
                }
            });
        });
///////////////////////////////////////////////////////////////
            ...
            function upload(img) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.fail) {
                            $('#profileImage').attr('src', '{{theme_asset('public/user_dashboard/images/avatar.jpg')}}');
                            // alert(data.errors['file']);
                            alert(data.errors);
                        }
                        else {
                            $('#file_name').val(data);
                            $('#profileImage').attr('src', '{{theme_asset('public/user_dashboard/profile')}}/' + data);
                            $('#profileImageHeader').attr('src', '{{theme_asset('public/user_dashboard/profile')}}/' + data);
                        }

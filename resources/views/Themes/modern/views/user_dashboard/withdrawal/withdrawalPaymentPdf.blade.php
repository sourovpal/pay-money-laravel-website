                ...
                <td>
                    <table style="margin-top:20px; width:300px;">
                        ...
                        <tr>
                            ...
                            <td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->subtotal, $transactionDetails->currency_id)) }}
                            </td>
                        </tr>
                        ...
                        @if (abs($transactionDetails->total) - abs($transactionDetails->subtotal) > 0)
                            <tr style="padding-bottom:10px;">
                                ...
                                <td style="font-size:15px; color:#4e5c6e; text-align:right;">
                                    {{ moneyFormat(optional($transactionDetails->currency)->symbol, formatNumber($transactionDetails->charge_percentage + $transactionDetails->charge_fixed, $transactionDetails->currency_id)) }}
                                </td>
                            </tr>
                        @endif

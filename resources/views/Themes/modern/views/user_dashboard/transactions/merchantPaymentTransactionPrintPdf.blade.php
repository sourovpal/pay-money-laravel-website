                        ...
                        <table style="margin-top:20px; width:300px;">
                            ...
                            <tr style="padding-bottom:10px;">
                                ...
                                <td style="font-size:15px; color:#4e5c6e; text-align:right;">
                                    {{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->charge_percentage+$transaction->charge_fixed)) }}
                                </td>
                            </tr>
                            @endif
                            <tr>
                            ...
                            <tr>
                                <td style="font-size:15px; color:#000000; font-weight:bold;">@lang('message.dashboard.left-table.total')</td>
                                <td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat(optional($transaction->currency)->symbol, formatNumber($transaction->total)) }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>

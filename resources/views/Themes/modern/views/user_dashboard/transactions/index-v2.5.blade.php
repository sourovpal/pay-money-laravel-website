...
@section('css')
    <!--daterangepicker-->
    <link rel="stylesheet" type="text/css" href="{{theme_asset('public/user_dashboard/css/daterangepicker.css')}}">
@endsection
                                                                    ...
                                                                    @else
                                                                        @if(!empty($payment_method))
                                                                            @if ($transaction->payment_method_id == 1)
                                                                                @if (!empty($img))
                                                                                    <img src="{{theme_asset('public/images/logos/'.$img)}}" class="rounded-circle rounded-circle-custom-trans">
                                                                                @else
                                                                                    <img src="{{theme_asset('public/uploads/userPic/default-logo.jpg')}}" class="rounded-circle rounded-circle-custom-trans">
                                                                                @endif
                                                                            @else
...
@section('js')
    ...
    <!--daterangepicker-->
    <script src="{{theme_asset('public/user_dashboard/js/daterangepicker.js')}}" type="text/javascript"></script>

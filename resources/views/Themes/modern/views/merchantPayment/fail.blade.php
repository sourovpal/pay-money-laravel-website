...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ theme_asset('public/backend/bootstrap/dist/css/bootstrap.css') }}">
    <script src="{{ theme_asset('public/backend/jquery/dist/jquery.js') }}"></script>
    <script src="{{ theme_asset('public/backend/bootstrap/dist/js/bootstrap.min.js') }}"></script>

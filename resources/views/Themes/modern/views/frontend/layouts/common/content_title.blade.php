        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                if($wallets->count()>0){
                    ...
                    $li .="<li class='text-left'>".$result->currency->code.' '. decimalFormat($result->balance)."</li>";
                    }
                }
                ...
                <div class="banner-amount">
                    <h4 class="text-white">{{ __('Available balance') }}</h4>
                    <h2 class="text-white"> {{ current_balance() }} </h2>
                </div>
            </div>
        </div>
    </div>
